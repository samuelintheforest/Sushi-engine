...
namespace Sushi {
	...
	public:
		...
		Sushi::Scene::SceneDescription* scene;

		Renderer(unsigned int batchLimit, Shader* shader, float* txIds, float* fontTxIds, Sushi::Scene::SceneDescription *m_SceneDescINput);
		~Renderer(void);
		void begin();
		void end();
		void draw3d_EXP();
